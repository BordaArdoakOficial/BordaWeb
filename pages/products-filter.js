...
(function () {
  ...
  var FIXED_WINERIES = [
    ...
    'Lagar de Besada', 'Eido da Fonte', 'Marqués de Vizhoja',
    ...
    'Cresta Rosa (Aguja)', 'Don Luciano', 'Irache', 'La cacciatora', 'Matteus',
  ...
  var FIXED_FACET_ITEMS = {
    type: isES
      ? [
          ...
          'Sidras', 'Txakolis', 'Cavas', 'Refrescos', 'Lácteos', 'Patatas', 'Conservas', 'Aceites'
        ]
      : [
          { value: 'Ardoak', children: ['Urtekoak', 'Onduak', 'Erreserbak', 'Zuriak', 'Gorriak'] },
          'Sagardoak', 'Txakoliñak', 'Cavak', 'Freskagarriak', 'Esneak', 'Patatak', 'Kontserbak', 'Olioak'
        ],
    dok: isES
